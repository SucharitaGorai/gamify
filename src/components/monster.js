// Shooter Quiz Game: NCERT Class 8 Science - Force (Pure JavaScript)
...
(function runGame() {
  ...
  while (playerHP > 0 && monsterHP > 0 && wrongAnswers < 5 && correctAnswers < 10) {
    if (qIndex >= shuffled.length) {
      // Reshuffle or loop questions if needed
      shuffle(shuffled);
      qIndex = 0;
    }
    ...
    if (![1, 2, 3, 4].includes(choice)) {
      ...
      // Repeat this question without penalty
      qIndex--; // step back to re-ask
      continue;
    }
